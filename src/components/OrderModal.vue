      ...
      <div class="modal-body">
        <div class="row">
            ...
            <table class="table">
              <tbody>
                ...
                <tr>
                  <th>訂購時間</th>
                  <td>
                    {{ new Date(this.$props.tempOrders.create_at * 1000).toLocaleDateString() }}
                  </td>
                </tr>
                <tr>
                  <th>付款狀態</th>
                  <td>
                    <span
                      ...
                      >{{ this.$props.tempOrders.is_paid ? '已付款' : '未付款' }}</span
                    >
                  </td>
                </tr>
                <tr>
          ...
          <div class="form-check d-flex justify-content-end pe-5">
            ...
            />
            <label class="form-check-label px-3" :for="`{this.$props.tempOrders.id}`">
              <span>{{ this.$props.tempOrders.is_paid ? '已付款' : '未付款' }}</span>
            </label>
          </div>
        </div>
      </div>
